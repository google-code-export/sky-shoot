...
{
	class CoopSession : GameSession
	{
		public CoopSession(TileSet tileSet, int maxPlayersAllowed,
		...
		public override void Start()
		{
			...
			for (int i = 0; i < base._gameObjects.Count; i++)
			{
				...
				base._gameObjects[i].TeamIdentity = base._sessionTeamsList.GetTeamByNymber(1);
